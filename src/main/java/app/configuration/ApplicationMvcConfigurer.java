...
public class ApplicationMvcConfigurer implements WebMvcConfigurer {
  ...
  private static final String[] MAPPINGS = {"/colorpick/**","/css/**","/fonts/**","/icons/**","/images/**", "/js/**", "/linkup_images/**","/pictures.sailer.logos/**","/sass/**","/vendor/**"};
  private static final String[] LOCATIONS = {"/colorpick/","/css/","/fonts/","/icons/","/images/", "/js/", "/linkup_images/","/pictures.sailer.logos/","/sass/","/vendor/"};
